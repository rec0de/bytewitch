...
class NemesysTestset {
    ...
    private fun testSequenceAlignment1() {
        ...
        val segments1 = listOf(NemesysSegment(0, NemesysField.UNKNOWN), NemesysSegment(2, NemesysField.UNKNOWN))
        val segments2 = listOf(NemesysSegment(0, NemesysField.UNKNOWN), NemesysSegment(2, NemesysField.UNKNOWN))
        val segments3 = listOf(NemesysSegment(0, NemesysField.UNKNOWN), NemesysSegment(2, NemesysField.UNKNOWN))

        val messages = mapOf(
            0 to NemesysParsedMessage(segments1, message1, 0),
            1 to NemesysParsedMessage(segments2, message2, 1),
            2 to NemesysParsedMessage(segments3, message3, 2)
        )
    ...
    private fun testSequenceAlignment3() {
        ...
        val message4 = "".fromHex()
        ...
        val messages = mapOf(
            ...
            1 to NemesysParsedMessage(segments2, message2, 1),
            2 to NemesysParsedMessage(segments3, message3, 2),
            3 to NemesysParsedMessage(segments4, message4, 3)
        )
    ...
    private fun testSequenceAlignment4() {
        ...
        val message4 = "".fromHex()
        ...
        val expectedAlignments = setOf(
            ...
            Triple(1, 3, Pair(14, 14)),
            Triple(2, 3, Pair(14, 14)),
            Triple(3, 2, Pair(25, 25)),
            Triple(3, 1, Pair(25, 23)),
            Triple(3, 0, Pair(25, 25)),
            Triple(2, 1, Pair(25, 23)),
            Triple(2, 0, Pair(25, 25)),
            Triple(1, 0, Pair(23, 25)),
            Triple(0, 1, Pair(26, 24)),
            Triple(0, 2, Pair(26, 26)),
            Triple(0, 3, Pair(26, 26)),
            Triple(1, 2, Pair(24, 26)),
            Triple(1, 3, Pair(24, 26)),
            Triple(2, 3, Pair(26, 26)),
            Triple(3, 2, Pair(27, 27)),
            Triple(3, 1, Pair(27, 25)),
            Triple(3, 0, Pair(27, 27)),
            Triple(2, 1, Pair(27, 25)),
            Triple(2, 0, Pair(27, 27)),
            Triple(1, 0, Pair(25, 27)),
            Triple(0, 1, Pair(28, 26)),
            Triple(0, 2, Pair(28, 28)),
            Triple(0, 3, Pair(28, 28)),
            Triple(1, 2, Pair(26, 28)),
            Triple(1, 3, Pair(26, 28)),
            Triple(2, 3, Pair(28, 28)),
            Triple(3, 2, Pair(29, 29)),
            Triple(3, 1, Pair(29, 27)),
            Triple(3, 0, Pair(29, 29)),
            Triple(2, 1, Pair(29, 27)),
            Triple(2, 0, Pair(29, 29)),
            Triple(1, 0, Pair(27, 29)),
            Triple(0, 1, Pair(31, 29)),
            Triple(0, 2, Pair(31, 31)),
            Triple(0, 3, Pair(31, 31)),
            Triple(1, 2, Pair(29, 31)),
            Triple(1, 3, Pair(29, 31)),
            Triple(2, 3, Pair(31, 31)),
            Triple(3, 2, Pair(30, 30)),
            Triple(3, 1, Pair(30, 28)),
            Triple(3, 0, Pair(30, 30)),
            Triple(2, 1, Pair(30, 28)),
            Triple(2, 0, Pair(30, 30)),
            Triple(1, 0, Pair(28, 30)),
            Triple(0, 1, Pair(32, 30)),
            Triple(0, 2, Pair(32, 32)),
            Triple(0, 3, Pair(32, 32)),
            Triple(1, 2, Pair(30, 32)),
            Triple(1, 3, Pair(30, 32)),
            Triple(2, 3, Pair(32, 32)),
            Triple(3, 2, Pair(33, 33)),
            Triple(3, 1, Pair(33, 31)),
            Triple(3, 0, Pair(33, 33)),
            Triple(2, 1, Pair(33, 31)),
            Triple(2, 0, Pair(33, 33)),
            Triple(1, 0, Pair(31, 33)),
            Triple(0, 1, Pair(21, 19)),
            Triple(0, 2, Pair(21, 21)),
            Triple(0, 3, Pair(21, 21)),
            Triple(1, 2, Pair(19, 21)),
            Triple(1, 3, Pair(19, 21)),
            Triple(2, 3, Pair(21, 21)),
            Triple(3, 2, Pair(22, 22)),
            Triple(3, 1, Pair(22, 20)),
            Triple(3, 0, Pair(22, 22)),
            Triple(2, 1, Pair(22, 20)),
            Triple(2, 0, Pair(22, 22)),
            Triple(1, 0, Pair(20, 22)),
            Triple(0, 1, Pair(23, 21)),
            Triple(0, 2, Pair(23, 23)),
            Triple(0, 3, Pair(23, 23)),
            Triple(1, 2, Pair(21, 23)),
            Triple(1, 3, Pair(21, 23)),
            Triple(2, 3, Pair(23, 23)),
            Triple(3, 2, Pair(24, 24)),
            Triple(3, 1, Pair(24, 22)),
            Triple(3, 0, Pair(24, 24)),
            Triple(2, 1, Pair(24, 22)),
            Triple(2, 0, Pair(24, 24)),
            Triple(1, 0, Pair(22, 24))
        )

        printSequenceAlignmentResult(4, messages, expectedAlignments)
    }
}