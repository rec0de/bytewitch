...
class KaitaiExpressionTests {
    ...
    fun tokenizerTest() {
        ...
        var result:  MutableList<Pair<Kaitai.TokenType, dynamic>> = kaitai.tokenizeExpression(expression)
        ...
        expression = "0B101010"
        result = kaitai.tokenizeExpression(expression)
    ...
    fun operationsTest() {
        ...
        var result: dynamic = kaitai.parseExpression(expression,
            MutableKaitaiTree(mutableListOf()),
            KTStruct(),
            KTStruct(),
            booleanArrayOf(),
            0)
        ...
        result = kaitai.parseExpression(expression,
            MutableKaitaiTree(mutableListOf()),
            KTStruct(),
            KTStruct(),
            booleanArrayOf(),
    ...
    fun arrayTest() {
        ...
        var result: dynamic = kaitai.parseExpression(
            expression,
            MutableKaitaiTree(mutableListOf()),
            KTStruct(),
            KTStruct(),
