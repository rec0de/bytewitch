...
object TLV8 : ByteWitchDecoder {
    ...
    override fun decode(data: ByteArray, sourceOffset: Int): ByteWitchResult {
        ...
        while(remainder.isNotEmpty()) {
            ...
            val type = remainder[0]
            val length = remainder[1].toInt()
...
class Tlv8Entry(val type: Byte, val length: Int, val value: ByteArray, override val sourceByteRange: Pair<Int, Int>) : ByteWitchResult {
    override fun renderHTML(): String {
