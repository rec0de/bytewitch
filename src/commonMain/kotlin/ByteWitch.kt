...
object ByteWitch {
    private val decoders = listOf<ByteWitchDecoder>(BPListParser, OpackParser, Utf8Decoder, Utf16Decoder, AppleProtobuf, ProtobufParser, ASN1BER, GenericTLV, TLV8, EntropyDetector, HeuristicSignatureDetector)
